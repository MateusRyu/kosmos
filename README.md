...
## Visão Geral
 ...
 - Uma área segura para artistas compartilharem seus projetos e itens para venda e/ou aluguel, fortalecendo conexões e ampliando oportunidades criativas.
...
```shell
git clone https://github.com/Lari07aaa/kosmos
```
...
3. Renomeie o arquivo `exampleConfig.properties` (em `/src/main/resources/`) para `config.properties` e atualize os dados para o seu próprio banco de dados;
...
6. Após iniciar, acesse no navegador: http://localhost:8080
...
### Gabriel Cavalcanti
Estudante de Engenharia de Software (19 anos), focado em Java. Futuro Engenheiro de Plataforma/DevOps. Evoluindo constantemente em lógica e bancos de dados. Player de Valorant e frequentador assíduo da academia.
